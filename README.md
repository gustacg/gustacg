...
<p align="center">Almost all of it is client software, closed source. Every project below opens its page on the site, with all modules recorded on video.</p>
...
<p align="center">Plus n8n, Docker Swarm, Traefik, Portainer, MinIO, Meta Tech Provider, Chatwoot, React Native, Expo, PWA, push notifications, RAG and embeddings.</p>
